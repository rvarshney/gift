...
{
    Album *album = [[Client instance] createAlbumWithTitle:@"Untitled Album" user:[PFUser currentUser] numPages:1 template:self.templates[indexPath.row] completion:nil];
