...
@interface TemplatesLayout ()

@property (nonatomic, strong) NSDictionary *layoutInfo;

@end

@implementation TemplatesLayout
...
- (void)prepareLayout
{
    ...
    for (NSInteger section = 0; section < sectionCount; section++) {
        ...
        for (NSInteger item = 0; item < itemCount; item++) {
            ...
            if (indexPath.item == 0) {
                UICollectionViewLayoutAttributes *titleAttributes = [UICollectionViewLayoutAttributes layoutAttributesForSupplementaryViewOfKind:@"TemplateTitle" withIndexPath:indexPath];
    ...
    newLayoutInfo[@"TemplateCell"] = cellLayoutInfo;
    newLayoutInfo[@"TemplateTitle"] = titleLayoutInfo;
...
{
    return self.layoutInfo[@"TemplateCell"][indexPath];
}

- (UICollectionViewLayoutAttributes *)layoutAttributesForSupplementaryViewOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath
{
    return self.layoutInfo[@"TemplateTitle"][indexPath];
}
